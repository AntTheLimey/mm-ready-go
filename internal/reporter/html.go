...
func RenderHTML(report *models.ScanReport, opts ReportOptions) string {
	...
	// Collect to-do items (findings with remediation, filtered by options).
	...
	sb = append(sb, `</nav>`)
	sb = append(sb, `<div class="sidebar-footer">mm-ready-go v0.1.0</div>`)
	sb = append(sb, `</div>`)
	...
	main = append(main, `<hr>`)
	main = append(main, `<p><em>Generated by mm-ready-go v0.1.0</em></p>`)
	main = append(main, `</div>`)
